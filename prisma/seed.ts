...
const FAQS = [
  ...
  { category: 'COMP', order: 20, question: '绩效考核怎么影响我的工资？',
    answer: '手册 § 7.2.2：A 档系数 1.2 / B 档 1.0 / C 档 0.8 / D 档 0.6 / E 档 0（绩效工资部分的系数）。\n\n• 连续半年 A 档 → 基础服务费"可被考虑"上调（§ 7.3.2）——注意是"可被考虑"而不是"一定调"。\n• 连续 3 次 C 档 → 工资下浮 30% 或淘汰（§ 7.3.3）。\n• 整年度未达 A 档 → 当年不享年终奖（§ 7.3.4）。\n\n是否调薪、调多少、调方向（上 / 下 / 不变）均由公司根据绩效结果、岗位价值、经营状况综合决定。' },

  { category: 'COMP', order: 25, question: '每年 4 月和 10 月是否一定会给我涨工资？',
    answer: '不一定。4 月和 10 月是薪酬评估窗口，公司可能在这两个时段内审视各岗位的薪酬水平；窗口本身不代表必然调薪。\n\n是否调薪由多个因素决定：\n• 上一周期绩效考核结果\n• 岗位在组织中的关键程度、稀缺性、市场水平\n• 公司整体经营状况与预算空间\n• 与其他同事的相对公平性\n\n公司明确保留以下权利：在任一窗口内不对你的工资进行调整；根据经营状况对工资进行冻结、下调或结构调整；将原定调薪延后或改以其他激励形式发放。\n\n更可靠的路径：通过任务池持续累积份外贡献，让"被看见"变成评估时的数据依据。' },
