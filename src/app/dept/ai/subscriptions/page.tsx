/**
 * AI 平台月订阅管理 (/dept/ai/subscriptions)
 *
 * 全员可见可编辑（老板 5/10 决策：放开给大家填，AI 部内部协同）。
 * 录入公司订阅的各 AI / SaaS 平台月费：
 ...
 *
 * 原 /finance/subscriptions 保留 redirect 到本页（老板把订阅当作 AI 部范畴
 * 不在财务，让大家自己填）。
 */
    ...
    <div className="mx-auto max-w-5xl px-4 py-6 sm:px-6 sm:py-8">
      <header className="mb-5 flex flex-wrap items-baseline justify-between gap-2">
        <div className="flex items-baseline gap-3">
          <Link href="/dept/ai" className="text-sm text-slate-500 hover:text-slate-800">
            ← 返回 AI 部
          </Link>
